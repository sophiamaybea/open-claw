...
def main():
    ...
    parser.add_argument("--model", default="llama3.2:3b", help="Model name (Ollama or cloud model)")
    parser.add_argument("--provider", default="auto", choices=["auto", "groq", "ollama"], help="Model provider")
